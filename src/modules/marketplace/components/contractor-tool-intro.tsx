...
export function ContractorToolIntro({ copy, nasaq, locale }: Props) {
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-4 border-b border-ruwaq-stone/50 px-4 pb-10 pt-12 sm:flex-row sm:items-end sm:justify-between sm:px-6">
      <div>
        <NasaqBrandLockup name={nasaq.name} tagline={nasaq.tagline} />
        <h2 id="home-tool-title" className="ruwaq-section-title mt-4 text-start text-2xl sm:text-[1.75rem]">
          {locale === "ar" ? (
            <>
