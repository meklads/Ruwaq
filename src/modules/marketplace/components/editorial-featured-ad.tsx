...
type Props = {
  ...
  cta: Cta;
  visual: ReactNode;
  /** Outer section background — banner stays sage green inside. */
...
export function EditorialFeaturedAd({
  ...
  return (
    <section
      id={id}
      className={`ruwaq-ad-featured-section ruwaq-ad-featured-section--${sectionTone} scroll-mt-28`}
      aria-labelledby={titleId}
    >
      <div className="ruwaq-ad-featured-section__frame">
        <div className="ruwaq-ad-featured-banner">
          <div className="ruwaq-ad-featured-banner__inner">
            <div className="ruwaq-ad-featured-banner__copy">
              ...
              <p className="ruwaq-ad-featured-offer">
                ...
                {copy.offerStrike ? (
                  <s className="ruwaq-ad-featured-offer-strike">{copy.offerStrike}</s>
                ) : null}
