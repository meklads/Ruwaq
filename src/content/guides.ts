...
export const RUWQ_GUIDES: RuwaqGuide[] = [
  ...
  },
  {
    ...
    bodyAr: [
      ...
      "في جدة: احرص على حساب heat load صحيح مع هامش 10 to 15% للرطوبة.",
    ...
    bodyEn: [
      ...
      "In Jeddah: ensure accurate heat-load calculations with a 10 to 15% margin for humidity.",
  ...
  },
  {
    ...
    bodyAr: [
      ...
      "عزل الأسطح والخزانات يُجدّد كل 5 to 7 سنوات, ادمجه في العقد أو كـ variation منفصل.",
    ...
    bodyEn: [
      ...
      "Roof and tank waterproofing renews every 5 to 7 years, bundle it in the contract or as a separate variation.",
  ...
  },
  {
    ...
    bodyAr: [
      ...
      "نظام الري: drip irrigation مع controller ذكي يوفر 30 to 40% من استهلاك المياه.",
    ...
    bodyEn: [
      ...
      "Irrigation: drip systems with smart controllers save 30 to 40% water versus manual watering.",
