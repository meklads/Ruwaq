...
export const en: Messages = {
 ...
 marketplace: {
  ...
  projectTours: {
   ...
   viewAll: "All tours",
   readTour: "View tour",
   metaTitle: "Tours & new projects | Ruwaq PRO",
   metaDescription:
    "Off-plan launches with a dedicated page per project, plus editorial tours of completed work in Jeddah, Makkah, and Madinah.",
